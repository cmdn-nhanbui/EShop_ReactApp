...
import { GuaranteeIcon, MaterialIcon, PaymentIcon, TruckIcon } from '../../../shared/components/Icons'

const choosingItems: ChooseItemProps[] = [
  {
    icon: <TruckIcon width={34} height={34} className='choosing-icon' color='inherit' />,
    title: 'Free Shipping',
    description: 'All purchases over $199 are eligible forfree shipping via USPS First Class Mail.',
  },
  {
    icon: <PaymentIcon width={34} height={34} className='choosing-icon' color='inherit' />,
    title: 'Easy Payments',
    description: 'All payments are processed instantlyover a secure payment protocol.',
  },
  {
    icon: <GuaranteeIcon width={34} height={34} className='choosing-icon' color='inherit' />,
    title: 'Money-Back Guarantee',
    description: "If an item arrived damaged or you'vechanged your mind, you can send itback for a full refund.",
  },
  {
    icon: <MaterialIcon width={34} height={34} className='choosing-icon' color='inherit' />,
